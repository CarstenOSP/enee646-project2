...
const op_level1_t op_table[] = {
    ...
    {{"jal", FU_GROUP_BRANCH, OPERATION_JAL, DATA_TYPE_W}, NULL},
    {{"jalr", FU_GROUP_BRANCH, OPERATION_JALR, DATA_TYPE_W}, NULL},
...
const op_level2_t op_int_table[] = {
    {{"add", FU_GROUP_INT, OPERATION_ADD, DATA_TYPE_W}, NULL},
    {{"and", FU_GROUP_INT, OPERATION_AND, DATA_TYPE_W}, NULL},
    {{"or", FU_GROUP_INT, OPERATION_OR, DATA_TYPE_W}, NULL},
    {{"xor", FU_GROUP_INT, OPERATION_XOR, DATA_TYPE_W}, NULL},
    {{"sll", FU_GROUP_INT, OPERATION_SLL, DATA_TYPE_W}, NULL},
    {{"srl", FU_GROUP_INT, OPERATION_SRL, DATA_TYPE_W}, NULL},
    {{"slt", FU_GROUP_INT, OPERATION_SLT, DATA_TYPE_W}, NULL},
...
const op_level2_t op_br_table[] = {
    {{"beq", FU_GROUP_BRANCH, OPERATION_BEQ, DATA_TYPE_W}, NULL},
    {{"bne", FU_GROUP_BRANCH, OPERATION_BNE, DATA_TYPE_W}, NULL},
    {{NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE}, NULL},
    {{NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE}, NULL},
    {{NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE}, NULL},
    {{NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE}, NULL},
...
const op_level2_t op_imm_table[] = {
    {{"addi", FU_GROUP_INT, OPERATION_ADD, DATA_TYPE_W}, NULL},
    {{"andi", FU_GROUP_INT, OPERATION_AND, DATA_TYPE_W}, NULL},
    {{"ori", FU_GROUP_INT, OPERATION_OR, DATA_TYPE_W}, NULL},
    {{"xori", FU_GROUP_INT, OPERATION_XOR, DATA_TYPE_W}, NULL},
    {{"slli", FU_GROUP_INT, OPERATION_SLL, DATA_TYPE_W}, NULL},
    {{"srli", FU_GROUP_INT, OPERATION_SRL, DATA_TYPE_W}, NULL},
    {{"slti", FU_GROUP_INT, OPERATION_SLT, DATA_TYPE_W}, NULL},
    {{"sltiu", FU_GROUP_INT, OPERATION_SLT, DATA_TYPE_W}, NULL},
};
...
const op_level3_t op_intrr_table[] = {
    {"sltu", FU_GROUP_INT, OPERATION_SLTU, DATA_TYPE_W},
    ...
    {NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE},
    {NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE},
    {"sub", FU_GROUP_INT, OPERATION_SUB, DATA_TYPE_W},
    {NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE},
    {NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE},
    {NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE},
    {NULL, FU_GROUP_INVALID, OPERATION_NONE, DATA_TYPE_NONE},
...
const op_info_t *perform_operation(int instr, int pc, unsigned char *mem, int ea, operand_t operand1, operand_t operand2,
                      operand_t *result, int *target) {
  const op_info_t *op_info;
  int use_imm;
  ...
  switch (op_info->fu_group_num) {
    case FU_GROUP_INT:
      switch (op_info->operation) {
        ...
        case OPERATION_SUB:
          ...
          break;
        case OPERATION_SLL:
          result->integer.wu = operand1.integer.wu << operand1.integer.wu;
          break;
        case OPERATION_SRL:
          result->integer.wu = operand1.integer.wu >> operand1.integer.wu;
          break;
        ...
        case OPERATION_XOR:
          ...
          break;
        case OPERATION_SLT:
          result->integer.w = operand1.integer.w < operand1.integer.w;
          break;
        case OPERATION_SLTU:
          result->integer.wu = operand1.integer.wu < operand1.integer.wu;
          break;
    ...
    case FU_GROUP_MEM:
      if (ea) {
        *target = operand1.integer.w + operand2.integer.w;
      } else {
        if (op_info->operation == OPERATION_LOAD) {
          // printf("Fu Address %x | ", operand1.integer.wu);
          if (op_info->data_type == DATA_TYPE_W) {
              memcpy(&result->integer, &mem[operand1.integer.wu],
                     sizeof(int_t));
            } else {
              memcpy(&result->flt, &mem[operand1.integer.wu],
                     sizeof(float));
            }
        } else {
          if (op_info->data_type == DATA_TYPE_W) {
            result->integer = operand2.integer;
          } else {
            result->flt = operand2.flt;
          }
        }
      }
      break;
    ...
    //Gonna need to fix this one for sure
    case FU_GROUP_BRANCH:
      switch (op_info->operation) {
        case OPERATION_JAL:
          result->integer.wu = pc;
          *target = pc + FIELD_OFFSET(instr);
          break;
        case OPERATION_JALR:
          result->integer.wu = pc;
          *target = operand1.integer.wu;
          break;
        case OPERATION_BEQ:
          *target = pc + FIELD_IMM_S(instr);
          result->integer.w = (operand1.integer.w == operand2.integer.w);
          /*printf("%d, %d, %ld, %ld", *address, result->integer.wu,
                                    operand1.integer.w, operand2.integer.w);*/
          break;
        case OPERATION_BNE:
          *target = pc + FIELD_IMM_S(instr);
          result->integer.wu = (operand1.integer.w != operand2.integer.w);
          break;
      }
      break;
